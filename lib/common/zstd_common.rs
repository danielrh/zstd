...
pub unsafe extern "C" fn ZSTD_versionNumber() -> libc::c_uint {
    return (1i32 * 100i32 * 100i32 + 3i32 * 100i32 + 5i32) as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn ZSTD_versionString() -> *const libc::c_char {
    return (*::std::mem::transmute::<&[u8; 6],
                                                             ...
                                                             (::std::mem::size_of::<size_t>()
                                                                  ...
                                                                  libc::c_ulong).wrapping_mul(8i32
                                                                                                  ...
                                                                                                  libc::c_ulong).wrapping_sub(16i32
                                                                                                                                  ...
                                                                                                                                  libc::c_ulong))
                            as size_t as size_t;
                    current_block = 7065341985293521581;
                }
                6 => { current_block = 7065341985293521581; }
                5 => { current_block = 16838473045109834629; }
                4 => { current_block = 7338997171777974246; }
                3 => { current_block = 15661952671190409192; }
                2 => { current_block = 715565449213662477; }
                                                             ...
                                                             (::std::mem::size_of::<size_t>()
                                                                  ...
                                                                  libc::c_ulong).wrapping_mul(8i32
                                                                                                  ...
                                                                                                  libc::c_ulong).wrapping_sub(32i32
                                                                                                                                  ...
                                                                                                                                  libc::c_ulong))
                            as size_t as size_t;
                    current_block = 7338997171777974246;
                }
                _ => { }
            }
            match current_block {
                    ...
                    (*bitD).bitContainer =
                        ((*bitD).bitContainer as
                             libc::c_ulong).wrapping_add((*(srcBuffer as
                                                             ...
                                                             24i32) as size_t
                            as size_t;
                    current_block = 15661952671190409192;
                }
                _ => { }
            }
            match current_block {
                15661952671190409192 => {
                    (*bitD).bitContainer =
                        ((*bitD).bitContainer as
                             libc::c_ulong).wrapping_add((*(srcBuffer as
                                                             ...
                                                             16i32) as size_t
                            as size_t;
                    current_block = 715565449213662477;
                }
                _ => { }
            }
            match current_block {
...
pub unsafe extern "C" fn ZSTD_calloc(mut size: size_t,
 ...
 -> *mut libc::c_void {
    if customMem.customAlloc.is_some() {
        ...
        return ptr
    } else { return calloc(1i32 as libc::c_ulong, size) };
}
#[no_mangle]
