...
pub unsafe extern "C" fn FSE_readNCount(mut normalizedCounter:
    ...
    if hbSize < 4i32 as libc::c_ulong {
        ...
        nbBits =
            (bitStream &
                 15i32 as libc::c_uint).wrapping_add(5i32 as libc::c_uint) as
                libc::c_int;
        if nbBits > 15i32 {
            ...
            *tableLogPtr = nbBits as libc::c_uint;
            ...
            while 0 !=
                ...
                if (bitStream & (threshold - 1i32) as libc::c_uint) <
                       max as U32 {
                    count =
                    ...
                    count =
                        (bitStream &
                             (2i32 * threshold - 1i32) as libc::c_uint) as
                            libc::c_int;
                ...
                let fresh1 = charnum;
                charnum = charnum.wrapping_add(1);
                *normalizedCounter.offset(fresh1 as isize) =
                    count as libc::c_short;
                ...
                if ip <= iend.offset(-7isize) ||
                    ...
                    bitCount -=
                        (8i32 as libc::c_long *
                             ip.offset_to(iend.offset(-4isize)).expect("bad offset_to")
                                                             ...
                                                             (::std::mem::size_of::<size_t>()
                                                                  ...
                                                                  libc::c_ulong).wrapping_mul(8i32
                                                                                                  ...
                                                                                                  libc::c_ulong).wrapping_sub(16i32
                                                                                                                                  ...
                                                                                                                                  libc::c_ulong))
                            as size_t as size_t;
                    current_block = 4330899611860866800;
                }
                6 => { current_block = 4330899611860866800; }
                5 => { current_block = 2598574430693790173; }
                4 => { current_block = 15926143460950347726; }
                3 => { current_block = 15965096099016584895; }
                2 => { current_block = 13819124940814712673; }
                                                             ...
                                                             (::std::mem::size_of::<size_t>()
                                                                  ...
                                                                  libc::c_ulong).wrapping_mul(8i32
                                                                                                  ...
                                                                                                  libc::c_ulong).wrapping_sub(24i32
                                                                                                                                  ...
                                                                                                                                  libc::c_ulong))
                            as size_t as size_t;
                    current_block = 2598574430693790173;
                }
                _ => { }
            }
            match current_block {
                    ...
                    (*bitD).bitContainer =
                        ((*bitD).bitContainer as
                             libc::c_ulong).wrapping_add((*(srcBuffer as
                                                             ...
                                                             24i32) as size_t
                            as size_t;
                    current_block = 15965096099016584895;
                }
                _ => { }
            }
            match current_block {
                15965096099016584895 => {
                    (*bitD).bitContainer =
                        ((*bitD).bitContainer as
                             libc::c_ulong).wrapping_add((*(srcBuffer as
                                                             ...
                                                             16i32) as size_t
                            as size_t;
                    current_block = 13819124940814712673;
                }
                _ => { }
            }
            match current_block {
                13819124940814712673 => {
                    (*bitD).bitContainer =
                        ((*bitD).bitContainer as
                             libc::c_ulong).wrapping_add((*(srcBuffer as
    ...
    if 0 == srcSize {
            ...
            if iSize.wrapping_add(1i32 as libc::c_ulong) > srcSize {
                ...
                while (n as libc::c_ulong) < oSize {
                    *huffWeight.offset(n as isize) =
                        (*ip.offset(n.wrapping_div(2i32 as libc::c_uint) as
                                        isize) as libc::c_int >> 4i32) as
                            BYTE;
                    *huffWeight.offset(n.wrapping_add(1i32 as libc::c_uint) as
                                           isize) =
                        (*ip.offset(n.wrapping_div(2i32 as libc::c_uint) as
                                        isize) as libc::c_int & 15i32) as
                            BYTE;
                    n =
                        (n as libc::c_uint).wrapping_add(2i32 as libc::c_uint)
                            as U32 as U32
                }
            }
        } else {
            ...
            if iSize.wrapping_add(1i32 as libc::c_ulong) > srcSize {
                ...
                oSize =
                    FSE_decompress_wksp(huffWeight as *mut libc::c_void,
                                        hwSize.wrapping_sub(1i32 as
                                                                libc::c_ulong),
                                        ip.offset(1isize) as
                                            *const libc::c_void, iSize,
        ...
        while (n_0 as libc::c_ulong) < oSize {
            if *huffWeight.offset(n_0 as isize) as libc::c_int >= 12i32 {
                ...
                let ref mut fresh2 =
                    *rankStats.offset(*huffWeight.offset(n_0 as isize) as
                                          isize);
                *fresh2 = (*fresh2).wrapping_add(1);
                weightTotal =
                    (weightTotal as
                         libc::c_uint).wrapping_add((1i32 <<
                                                         *huffWeight.offset(n_0
                                                                                as
                                                                                isize)
                                                             as libc::c_int >>
                                                         1i32) as
                ...
                if verif != rest {
                    ...
                    *fresh3 = (*fresh3).wrapping_add(1);
                    if *rankStats.offset(1isize) < 2i32 as libc::c_uint ||
                           0 !=
                               *rankStats.offset(1isize) &
                                   1i32 as libc::c_uint {
                        return -(ZSTD_error_corruption_detected as
                                     libc::c_int) as size_t
                    } else {
                        *nbSymbolsPtr =
                            oSize.wrapping_add(1i32 as libc::c_ulong) as U32;
